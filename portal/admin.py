...
from portal.models import Empresa, Curso, Aluno, Ocorrencia, Turma, UserProfile, Matricula, Falta, CategoriaFalta, \
    Servico, ServicoCategoria, Encaminhamento, Autorizacao, Configuracao, Banco, Justificativa
...
class MatriculaAdmin(ImportExportModelAdmin):
    list_display = ('id', 'aluno', 'turma', 'ano_letivo', 'empresa')
    list_filter = ['turma__curso', 'ano_letivo', 'empresa']
    search_fields = ['aluno__nome', 'turma__curso__descricao', 'turma__descricao']
...
class JustificativaAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'matricula', 'data_inicial', 'status')
